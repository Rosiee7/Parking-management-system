<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="ParkingManager.Contact" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" style="margin-left: 133px" Width="369px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        </asp:GridView>
